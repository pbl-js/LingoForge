...
export function GuessWordInSentence({
  ...
  return (
    <div className="relative flex flex-col min-h-full max-w-[400px] gap-8 grow">
      {/* Background Image Container */}
      <div className="fixed inset-0 -z-10 overflow-hidden">
        <div className="absolute inset-0 -m-[5%] scale-110">
          <Image
            src="https://ueetgnxhw203rpll.public.blob.vercel-storage.com/static-image/accomodation-x6uU5QxcAUcOdlVOfQ01CWZWi12CHt.jpg"
            alt="background"
            fill
      ...
      {/* Remove the existing image container and keep the content */}
